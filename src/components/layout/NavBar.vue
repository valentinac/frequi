      ...
      <div class="flex justify-between w-full text-center items-center ms-3">
        ...
        <div v-if="!isMobile" class="flex ms-auto">
          ...
          <div class="flex justify-between">
            ...
            <ReloadControl class="me-3" title="确认停用对话框." />
          </div>
          <div
          ...
          >
            <template #container>
              <div class="flex flex-row items-center">
                <h3 class="text-xl font-bold w-full text-center text-surface-200">FaiQ UI</h3>
                <Button
              ...
              <div class="flex flex-col gap-1 items-center mt-4">
                ...
                <ReloadControl class="justify-center w-full" title="确认停用对话框." />
              </div>
            </template>
          </Drawer>
        </div>
